...
class NotificationActivity : BaseDarkActivity<ActivityNotificationBinding,
        NotificationViewModel>(NotificationViewModel::class.java), View.OnClickListener {
    ...
    private fun viewModelInitialize() {
        ...
        observerViewModel(
            viewModel.mNotificationResponse,
