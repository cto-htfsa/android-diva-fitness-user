...
abstract class SwipeToDeleteCallback internal constructor(private var mContext: Context) : ItemTouchHelper.Callback() {
    ...
    private val backgroundColor: Int = Color.parseColor("#F84B4B")
    private val deleteDrawable: Drawable?
    private val intrinsicWidth: Int
    private val intrinsicHeight: Int
    private val height = 70
    private val width = 70
    private val swipe = ItemTouchHelper.LEFT or ItemTouchHelper.START

    init {
        mClearPaint.xfermode = PorterDuffXfermode(PorterDuff.Mode.CLEAR)
        deleteDrawable = ContextCompat.getDrawable(mContext, R.drawable.swipe_delete)
    ...
    override fun getMovementFlags(recyclerView: RecyclerView, viewHolder: RecyclerView.ViewHolder): Int {
        return ItemTouchHelper.Callback.makeMovementFlags(0, swipe)
    }
